...
Furthermore, the [![monthicon_9.png](/hanafuda/icons/monthicon_9.png =20x)Sake Cup](/en/hanafuda/suits/chrysanthemum#sake-cup) may be treated as either an Animal *or* 2 Chaff (not both!), while the [![Icon for month 12](/hanafuda/icons/monthicon_12.png =20x)Yellow Paulownia](/en/hanafuda/suits/paulownia#yellow-bottom-chaff), and [![Icon for month 11](/hanafuda/icons/monthicon_11.png =20x)Lightning](/en/hanafuda/suits/willow#lightning) cards each count as 2 Chaff.
...
- In some descriptions of the game, any triplets that a player revealed at the beginning of the round can *not* subsequently be used to bomb the field.
