...
Alternatively, some play with a simpler, higher-stakes rule in which all field multiplers stack. So, in the example above, the field multiplier for the round will be a hefty 32 (4 x 4 x 2).
