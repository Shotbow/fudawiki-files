...
If the wild card is on the field, it may be captured using another ![monthicon_11.png](/hanafuda/icons/monthicon_11.png =20x)Willow card **or** using any non-0-point card (this might not be allowed in some variants).
