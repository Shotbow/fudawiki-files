...
## Older *Yaku*
The yaku given in the body of the page are typical of modern sources. Slightly older descriptions instead give the following list, which some may find easier to work with.
